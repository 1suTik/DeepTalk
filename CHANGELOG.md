...
## Task 5锛氬疄鐜伴棶棰樻娴嬨€佸幓閲嶄笌涓婁笅鏂囩獥鍙?
**鏃ユ湡锛?* 2026-08-01

### 浜や粯鍐呭

- `src-tauri/src/question/normalizer.rs`锛氭枃鏈鑼冨寲锛堝叏瑙掆啋鍗婅銆佸幓鏍囩偣銆佹姌鍙犵┖鐧姐€佸皬鍐欙級锛岀敤浜庡幓閲嶅搱甯屼笌妫€绱㈠尮閰?- `src-tauri/src/question/detector.rs`锛氳交閲忔湰鍦伴棶棰樻娴嬪櫒
  - 瑙勫垯瑕嗙洊锛氫腑鏂囧彞鏈枒闂瘝锛堝悧/鍛?鍚э級銆佷腑鏂囩枒闂瘝锛堜负浠€涔?鎬庝箞/濡備綍/浠€涔?澶氬皯/鏄惁/鑳藉惁/鍝簺/鍝噷/璋侊級銆佷腑鏂囧懡浠ゅ紡锛堣浠嬬粛/浠嬬粛涓€涓?璋堣皥/璇磋/璁茶/瑙ｉ噴/涓句緥/璇存槑/鎻忚堪锛夈€佽嫳鏂囩枒闂瘝寮€澶达紙who/what/why/how/does/is/can 绛夛級銆佽嫳鏂囧懡浠ゅ紡锛坉escribe/explain/tell me/what about锛?  - 缃俊搴﹀垎绾э細**Auto 鈮?0.65**锛堣嚜鍔ㄧ敓鎴愶級銆?*Maybe 0.40-0.64**锛堜粎鏄剧ず銆屽彲鑳界殑闂銆嶏紝鐢ㄦ埛鐐瑰嚮鐢熸垚锛夈€?*< 0.40 蹇界暐**
  - 鏈€杩?20 绉?remote 鏈€缁堟枃鏈獥鍙ｏ紝鐩搁偦鐭彞鑷姩鍚堝苟锛涜Е鍙戞垚鍔熷悗绐楀彛娓呯┖
  - 鏍囧噯鍖栨枃鏈搱甯?30 绉掑唴鍘婚噸
  - `check_manual`锛氬叏灞€蹇嵎閿墜鍔ㄦ彁浜わ紙涓嶅仛鍘婚噸锛夛紝鏁寸獥浣滀负闂

### 楠岃瘉缁撴灉

| 妫€鏌ラ」 | 缁撴灉 |
|---|---|
| `cargo test --manifest-path src-tauri/Cargo.toml question::` | 鍏?FAIL锛?2 椤规湭瀹炵幇锛夆啋 瀹炵幇鍚?PASS |
| 璇枡琛ㄦ祴璇?| 涓枃鐤戦棶鍙?鑻辨枃鐤戦棶鍙?鍛戒护寮忛潰璇曢/鏅€氶檲杩帮紙涓嫳锛?杩囩煭鏂囨湰/琚埅鏂棶棰?缃俊搴﹀垎甯?鐩搁偦鐭彞鍚堝苟/30s 鍘婚噸/绐楀彛娓呯悊/鎵嬪姩瑙﹀彂 鍏ㄩ儴 PASS |
| 鍏ㄩ噺 `cargo test` | PASS锛?0 閫氳繃 + 2 蹇界暐锛?|

### 鎻愪氦淇℃伅

- 鍒嗘敮锛歚feat/task-5-question-detection`
- commit锛氬緟琛ュ厖锛圫tep 4锛?- 鐘舵€侊細宸叉帹閫侊紝寰呯‘璁ゅ悗鍚堝苟 `main` 骞舵墦 `v0.1.0-m2` 閲岀▼纰?tag

### 璇存槑

- 妫€娴嬪櫒鍙秷璐?remote 婧愭渶缁堟枃鏈紙`push_final`锛夛紝涓庢湰鍦帮紙楹﹀厠椋庯級鏉ユ簮鏃犲叧
- 鍏ㄥ眬蹇嵎閿殑鎵嬪姩鎻愪氦鑳藉姏灏嗗湪 Task 9 鐨勪細璇濈紪鎺掍腑鎺ュ叆
...
- `src-tauri/models/models.json`锛氬畼鏂规ā鍨嬫竻鍗曪紙id銆佷笅杞?URL銆丼HA-256銆佸ぇ灏忋€佽瑷€鑼冨洿銆佽繍琛屾。浣嶏級锛岀紪璇戞湡鍐呭祵
...
- 瀹炴祴杞啓锛圴ulkan 鍚庣锛孯TX 3060 Ti锛夛細zh `璇蜂粙缁嶄竴涓嬩綘璐熻矗鐨勯」鐩甡銆乪n `What was the hardest problem you solved?`銆乻ilence `''`锛堢┖锛?- 宸茬敤鐪熷疄 SHA-256 `394221709cd5ad1f40c46e6031ca61bce88931e6e088c188294c6d5a55ffa7e2` 鍥炲～ models.json 鐨?large-v3-turbo 鏉＄洰
...
- commit锛歚85225ba`锛堝姛鑳斤級銆乣367e1f0`锛圕HANGELOG锛夈€乣1b34de7`锛圴ulkan 璁惧閫夋嫨涓庨潤闊抽棬鎺т慨澶嶏級銆乣81a6930`锛堟ā鍨嬮獙璇佽褰曪級銆乣5a549c7`锛坢odels.json 娓呭崟鍏ュ簱淇锛?- 鐘舵€侊細宸叉帹閫侊紝寰呯‘璁ゅ悗鍚堝苟 `main`
...
- commit锛歚3617634`锛堝姛鑳斤級銆乣d69dc70`锛圕HANGELOG 瀹氱锛夈€乣c95d387`锛坅udio 妯″潡瀵煎嚭涓庢瀯寤鸿剼鏈級銆乣9aafb34`锛堣鍛婃竻鐞嗭級
...
- commit锛歚668863b`锛圲I 楠ㄦ灦涓庝細璇濈姸鎬侊級銆乣7bdef21`锛圕HANGELOG 鍒涘缓锛夈€乣8209cec`锛坥verlay 棰勮鎺ョ嚎锛?- 鐘舵€侊細宸叉帹閫侊紝寰呯‘璁ゅ悗鍚堝苟 `main`
...
- 鏈枃浠跺繀椤讳繚鎸?UTF-8锛堟棤 BOM锛夌紪鐮侊紱绂佹浣跨敤 PowerShell `Set-Content` 鍥炲啓锛圥S 5.1 榛樿鎸?GBK 瑙ｇ爜瀵艰嚧涔辩爜锛?- 姣忔 Task 浜や粯锛氳拷鍔犳潯鐩紙浜や粯鍐呭 / 楠岃瘉缁撴灉 / 鎻愪氦淇℃伅 / 鐜璇存槑锛夛紝闅忓姛鑳藉垎鏀竴璧锋彁浜?